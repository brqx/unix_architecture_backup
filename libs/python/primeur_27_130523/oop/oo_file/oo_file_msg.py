...
class FileMsg(getsetGen):
    ...
    msg_open_file_code          = "Codigo de apertura del fichero"
    msg_file_name               = "Nombre del fichero"
    msg_file_type               = "Tipo de fichero"
    ...
    def __init__(self                               , 
        ...
        #- Para evitar herencia circular file no llama a log      
