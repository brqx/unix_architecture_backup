...
-+ Metodos definidos            : 
-----------------------------------------------------------
- get/setRulCorrelId            - Correlation Id
-----------------------------------------------------------
- get/setRulSender              - Emisor
-----------------------------------------------------------
- get/setRulDestinationFileName - Destination FileName
-----------------------------------------------------------
- get/setRulSourceFileName      - Source FileName
-----------------------------------------------------------
- get/setRulDirectory           - Directorio
-----------------------------------------------------------
- get/setRulSobrescritura       - Sobrescritura
-----------------------------------------------------------
- get/setRulCaracteres          - Caracteres
-----------------------------------------------------------
- get/setRulExtraccion          - Extraccion
-----------------------------------------------------------
- get/setRulPostProcess         - Post Proceso
-----------------------------------------------------------
- get/setRulPostProcessArgs     - Argumentos Post Proceso
-----------------------------------------------------------
- get/setRulCompress            - Compresion
-----------------------------------------------------------
- get/setRulTrigger             - Bandera
-----------------------------------------------------------
- get/setRulesFileName          - Fichero de reglas
-----------------------------------------------------------
- get/setRulCorrelIdTuple       - Correl Id Tuple
-----------------------------------------------------------
- get/setRulQueueManager        - Gestor de colas
-----------------------------------------------------------
- get/setRulQueue               - Cola de mensajes
-----------------------------------------------------------
- get/setRulUserClass           - Clase de usuario
-----------------------------------------------------------
- get/setRulDescription         - Descripcion
-----------------------------------------------------------
- get/setRulStandard            - Standard
-----------------------------------------------------------
- get/setRulCompressor          - Compresion - una es acq y  otra dsp
-----------------------------------------------------------
- get/setRulBackupDir           - Directorio de backup
-----------------------------------------------------------
- get/setRulUser                - Usuario
-----------------------------------------------------------
- get/setRulPasswd              - Passwd
-----------------------------------------------------------
...
#--==--==--==--==--==--==--==--==--==--==--==--==--==--==--=
    ...
    def getRulCopyDup(self):
        """ Retorno del atributo CopyDup
        """    

        valor_a_devolver = self.__rul_copydup
        self.logGet(valor_a_devolver, self.msg_rul_copydup)
        return valor_a_devolver
    

    def setRulCopyDup(self, argumento):
        """ Establecimiento del atributo CopyDup
        """    

        variable_a_establecer = self.__rul_copydup
        self.logSet(
            variable_a_establecer , 
            argumento , 
            self.msg_rul_copydup)

        self.__rul_copydup = argumento
