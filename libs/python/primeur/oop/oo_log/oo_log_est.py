...
-+ Metodos definidos        : 
-----------------------------------------------------------
- get/set_log_text_msg       -   Texto de mensaje
-----------------------------------------------------------
- get/set_log_value_msg      -   Valor del mensaje
-----------------------------------------------------------
- get/set_log_value_justify  -   Justificacion del mensaje
-----------------------------------------------------------
- get/set_log_value_len      -   Longitud de valor
-----------------------------------------------------------
- get/set_log_text_len       -   Longitud del texto
-----------------------------------------------------------
- get/set_log_level          -   Maximo nivel de log
-----------------------------------------------------------
- get/set_log_class_level    -   Nivel de log de profundidad
-----------------------------------------------------------
- get/set_log_show           -   Destino de los logs (screen)
-----------------------------------------------------------
- get/set_log_cls            -   Clase del log - no se usa
-----------------------------------------------------------
- get/set_log_mth            -   Metodo del log - no se usa
-----------------------------------------------------------
- get/set_log_file           -   Nombre fichero de log
-----------------------------------------------------------
- get/set_log_size           -   Tamano - size fichero de log
-----------------------------------------------------------
