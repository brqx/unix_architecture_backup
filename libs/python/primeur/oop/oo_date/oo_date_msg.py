...
+ Clases definidas      : 
--==--==--==--==--==--==--==--==--==--==--==--==--==--==--=
- DateMsg           - Clase de gestion de mensajes de Fechas
-----------------------------------------------------------
-+ Clases heredadas     : 
--=----=----=----=----=----=----=----=----=----=----=----=-
...
class DateMsg(getsetGen):
    ...
    #-Atributos publicos
    msg_mask                        = "Mascara de fecha a parsear "
    msg_date                        = "Fecha con mascara indicada"
        
    msg_time                        = "Hora actual"
    msg_date                        = "Fecha actual"
    msg_datetime                    = "Fecha y hora actuales"
