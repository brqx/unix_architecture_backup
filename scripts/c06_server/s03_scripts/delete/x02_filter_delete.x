...
filter_delete_revo ${DOCS_FOLDER}a
filter_delete_revo ${DOCS_FOLDER}c

filter_delete_zt ${DOCS_FOLDER}a
filter_delete_zt ${DOCS_FOLDER}c

filter_delete_za ${DOCS_FOLDER}a
filter_delete_za ${DOCS_FOLDER}c

filter_delete_zd ${DOCS_FOLDER}a
filter_delete_zd ${DOCS_FOLDER}c
