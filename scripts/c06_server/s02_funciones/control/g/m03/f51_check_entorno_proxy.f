...
check_entorno_proxy()
{
IS_check_entorno_proxy="Comprueba todo el entorno via proxy. Puerto http."
INFO_SCRIPT=${IS_check_entorno_proxy}
...
e_pmt check_entorno_proxy 

else
#-Esta informacion ira contra el proxy
