...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E show_logs_proxy	servidor_A	--> Lista los logs del servidor_A
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#-Busca en los logs filtrados la cadena y te muestra las lineas
show_logs_proxy()
{
IS_show_logs_proxy="Busca todos los logs en el entorno indicado via proxy"
INFO_SCRIPT=${IS_show_logs_proxy}
...
e_pmt show_logs_proxy "[contador] [maximo]"
...
SALIDA_show_logs_proxy=${SALIDA_lista_logs_proxy}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
cat  ${FICHERO_LOG} | grep -n ${CADENA_FICHERO} > PANTALLA_show_logs_proxy
...
INFO_SCRIPT=${INFO_SCRIPT_show_logs_proxy}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_show_logs_proxy}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_show_logs_proxy}
