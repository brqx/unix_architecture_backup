...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E lista_logs_no_proxy	servidor_A	--> Lista los logs del servidor_A
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#-La idea es hacer un chequeo de urls concatenando la cadenal de logs
lista_logs_no_proxy()
{
IS_lista_logs_no_proxy="Busca todos los logs en el entorno indicado sin usar el proxy"
INFO_SCRIPT=${IS_lista_logs_no_proxy}
...
e_pmt lista_logs_no_proxy "[contador] [maximo]"
...
SALIDA_lista_logs_no_proxy=${SALIDA_site_access_no_proxy}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
INFO_SCRIPT=${INFO_SCRIPT_lista_logs_no_proxy}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_lista_logs_no_proxy}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_lista_logs_no_proxy}
...
return ${SALIDA_lista_logs_no_proxy}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
