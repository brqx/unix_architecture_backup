...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E mvn_upd_app_release APP1 11_2 -- Oteniene la version 11_2 del artefacto APP1
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Alias mvuear
mvn_upd_app_release()
{
IS_mvn_upd_app_release="Obtiene el ear de maven"
INFO_SCRIPT=${IS_mvn_upd_app_release}
...
e_pmt mvn_upd_app_release "app [version] [ruta_destino] [ruta_nexus]"
...
mvn_get_app_release  ${APLICACION} ${VERSION} ${RUTA_NEXUS}
