...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E mvn_gfull_libraries_snapshot 11_2 -- Oteniene la version 11_2 de las librerias 
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Alias mvgfull
mvn_gfull_libraries_snapshot()
{
IS_mvn_gfull_libraries_snapshot="Descarga todas las librerias para la version indicada"
INFO_SCRIPT=${IS_mvn_gfull_libraries_snapshot}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_mvn_gfull_libraries_snapshot=${INFO_SCRIPT}

VERSION=${1}

SALIDA_mvn_gfull_libraries_snapshot=0
NOMBRE_PANTALLA_mvn_gfull_libraries_snapshot=PANTALLA_mvn_gfull_libraries_snapshot.dat

NOMBRE_SCRIPT_mvn_gfull_libraries_snapshot=mvn_gfull_libraries_snapshot
PARAMETROS_SCRIPT_mvn_gfull_libraries_snapshot="[VERSION]"
...
LIBRERIA[11]=MAPFRE_ARQOS_ENVCONFIG_VIDA_DIST
LIBRERIA[12]=MAPFRE_ARQOS_LOG4M_VIDA_DIST
...
echo "Lib : ${LIBRERIA[${cont_libs}]} " >> ${NOMBRE_PANTALLA_mvn_gfull_libraries_snapshot}
...
SALIDA_mvn_gfull_libraries_snapshot=${SALIDA_mvn_actual}
...
PANTALLA_SCRIPT="${NOMBRE_PANTALLA_mvn_gfull_libraries_snapshot}"

else

MOTIVO_FUNCION="No hay librerias nuevas. O hay errores (ruta incorrecta) o son viejas."
...
INFO_SCRIPT=${INFO_SCRIPT_mvn_gfull_libraries_snapshot}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_mvn_gfull_libraries_snapshot}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_mvn_gfull_libraries_snapshot}
...
return ${SALIDA_mvn_gfull_libraries_snapshot}
fi
}
