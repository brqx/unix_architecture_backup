...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E mvn_gsoa_libraries_snapshot 11_2 -- Oteniene la version 11_2 de las librerias 
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Alias mvgfull
mvn_gsoa_libraries_snapshot()
{
IS_mvn_gsoa_libraries_snapshot="Descarga todas las librerias para la version indicada"
INFO_SCRIPT=${IS_mvn_gsoa_libraries_snapshot}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_mvn_gsoa_libraries_snapshot=${INFO_SCRIPT}

VERSION=${1}

SALIDA_mvn_gsoa_libraries_snapshot=0
NOMBRE_PANTALLA_mvn_gsoa_libraries_snapshot=PANTALLA_mvn_gsoa_libraries_snapshot.dat

NOMBRE_SCRIPT_mvn_gsoa_libraries_snapshot=mvn_gsoa_libraries_snapshot
PARAMETROS_SCRIPT_mvn_gsoa_libraries_snapshot="[VERSION]"
...
e_pmt ${NOMBRE_SCRIPT_mvn_gsoa_libraries_snapshot} ${PARAMETROS_SCRIPT_mvn_gsoa_libraries_snapshot}
...
LIBRERIA[7]=MAPFRE_ARQOS_LOG4M_VIDA_DIST
...
echo "Lib : ${LIBRERIA[${cont_libs}]} " >> ${NOMBRE_PANTALLA_mvn_gsoa_libraries_snapshot}
...
SALIDA_mvn_gsoa_libraries_snapshot=${SALIDA_mvn_actual}
...
PANTALLA_SCRIPT="${PWD}/${NOMBRE_PANTALLA_mvn_gsoa_libraries_snapshot}"
...
INFO_SCRIPT=${INFO_SCRIPT_mvn_gsoa_libraries_snapshot}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_mvn_gsoa_libraries_snapshot}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_mvn_gsoa_libraries_snapshot}
...
return ${SALIDA_mvn_gsoa_libraries_snapshot}
fi
}
