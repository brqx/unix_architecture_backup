...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_arq_soa7b ARQOS 11_2 -- Actualiza la libreria con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Posible alias cfs
cf_path_to_arq_soa7b()
{
IS_cf_path_to_arq_soa7b="Actualiza la libreria en el servidor Core 7a"
...
e_pmt cf_path_to_arq_soa7b "BIBLIOTECA [version] "
