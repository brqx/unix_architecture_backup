...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_arq_frontal6a ARQOS 11_2 -- Actualiza la libreria con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Posible alias cfs
cf_path_to_arq_frontal6a()
{
IS_cf_path_to_arq_frontal6a="Actualiza la libreria en el servidor Frontal 6a"
INFO_SCRIPT=${IS_cf_path_to_arq_frontal6a}
...
SERVER=frontal6a
PORT=22
RUTA_DESTINO=/opt/bibliotecas_arquitectura/arqos/${LIBRERIA}
...
e_pmt cf_path_to_arq_frontal6a "BIBLIOTECA [version] "
