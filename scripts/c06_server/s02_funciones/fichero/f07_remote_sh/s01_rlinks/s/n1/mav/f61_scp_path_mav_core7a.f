...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_mav_core7a ARQOS 11_2 -- Actualiza la libreria maven con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Posible alias cfs
cf_path_to_mav_core7a()
{
IS_cf_path_to_mav_core7a="Actualiza la libreria en el servidor Core 7a"
INFO_SCRIPT=${IS_cf_path_to_mav_core7a}
