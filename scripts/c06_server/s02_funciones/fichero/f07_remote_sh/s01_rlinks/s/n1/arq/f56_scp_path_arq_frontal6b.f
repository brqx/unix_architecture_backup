...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_arq_frontal6b ARQOS 11_2 -- Actualiza la libreria con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Posible alias cfs
cf_path_to_arq_frontal6b()
{
IS_cf_path_to_arq_frontal6b="Actualiza la libreria en el servidor Core 7a"
INFO_SCRIPT=${IS_cf_path_to_arq_frontal6b}
...
e_pmt cf_path_to_arq_frontal6b "BIBLIOTECA [version] "
