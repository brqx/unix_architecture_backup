...
cf_path_to_mav_soa7a()
{
IS_cf_path_to_mav_soa7a="Actualiza la libreria en el servidor Core 7a"
INFO_SCRIPT=${IS_cf_path_to_mav_soa7a}
...
e_pmt cf_path_to_mav_soa7a "BIBLIOTECA [version] "
