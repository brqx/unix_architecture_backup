...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_mav_frontal6a ARQOS 11_2 -- Actualiza la libreria maven con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Posible alias cfs
cf_path_to_mav_frontal6a()
{
IS_cf_path_to_mav_frontal6a="Actualiza la libreria en el servidor Frontal 6a"
INFO_SCRIPT=${IS_cf_path_to_mav_core7b}
...
e_pmt cf_path_to_mav_frontal6a "BIBLIOTECA [version] "
