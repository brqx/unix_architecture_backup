...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_mav_core7b ARQOS 11_2 -- Actualiza la libreria maven con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Posible alias cfs
cf_path_to_mav_core7b()
{
IS_cf_path_to_mav_core7b="Actualiza la libreria maven en el servidor Core 7a"
...
e_pmt cf_path_to_mav_core7a "BIBLIOTECA [version] "
