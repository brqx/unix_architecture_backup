...
#-------------------------------------------------------------------
#-- cf_path_to_mavglobal_soa7a
#-------------------------------------------------------------------
#+ Funciones / Variables Requeridas
#-------------------------------------------------------------------
#-- e_pmt - cf_path_to_mav_soa7a
#-------------------------------------------------------------------
#+ Informacion : 
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_mav_soa7a 11_2 -- Actualiza la librerias maven con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

cf_path_to_mavglobal_soa7a()
{
IS_cf_path_to_mavglobal_soa7a="Actualiza la libreria en el servidor SOA 7a"
INFO_SCRIPT=${IS_cf_path_to_mavglobal_soa7a}
...
e_pmt cf_path_to_mavglobal_soa7a "[version] "
...
cf_path_to_mav_soa7a ${LIBRERIA[${cont}]} ${VERSION_MAV}
