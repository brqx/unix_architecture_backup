...
#-------------------------------------------------------------------
#-- cf_path_to_arqglobal_soa7b
#-------------------------------------------------------------------
#+ Funciones / Variables Requeridas
#-------------------------------------------------------------------
#-- e_pmt - cf_path_to_arq_soa7b
#-------------------------------------------------------------------
#+ Informacion : 
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_arqglobal_soa7b 11_2 -- Actualiza la libreria con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Posible alias cfs
cf_path_to_arqglobal_soa7b()
{
IS_cf_path_to_arq_soa7b="Actualiza la libreria en el servidor SOA 7b"
INFO_SCRIPT=${IS_cf_path_to_arq_soa7b}
...
e_pmt cf_path_to_arqglobal_soa7b "[version] "
...
##LIBRERIA[4]=MAPFRE_ARQOS_ENV_DIST
...
cf_path_to_arq_soa7b ${LIBRERIA[${cont}]} ${VERSION}
