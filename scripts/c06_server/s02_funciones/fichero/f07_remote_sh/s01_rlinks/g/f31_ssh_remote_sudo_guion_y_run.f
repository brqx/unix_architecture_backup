...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E ssh_surun ibm core 22 ruta usu grupo -- Genera enlace simbolico en destino
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

ssh_surun()
{
IS_ssh_surun="Ejecuta un comando en un servidor remoto como super usuario"
INFO_SCRIPT=${IS_ssh_surun}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_ssh_surun=${INFO_SCRIPT}
...
NOMBRE_SCRIPT_ssh_surun=ssh_surun
PARAMETROS_SCRIPT_ssh_surun="comando"
...
e_pmt ${NOMBRE_SCRIPT_ssh_surun} ${PARAMETROS_SCRIPT_ssh_surun}
...
#-- hace un sudo su - y luego ejecuta el comando
ssh -oPort=${PORT} ${USUARIO_CONEXION}@${SERVER} "sudo su - -c '${COMANDO}'" &> /dev/null
ERROR_ssh=$?

SALIDA_ssh_surun=${ERROR_ssh}
...
INFO_SCRIPT=${INFO_SCRIPT_ssh_surun}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_ssh_surun}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_ssh_surun}
