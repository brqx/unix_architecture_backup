...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cp_path_to_mavlocal_core lastversion 11_2 -- Actualiza la libreria maven con la version 11_2
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

cp_path_to_mavlocal_core()
{
IS_cp_path_to_mavlocal_core="Actualiza las librerias en el servidor Core 7a"
INFO_SCRIPT=${IS_cp_path_to_mavlocal_core}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_cp_path_to_mavlocal_core=${INFO_SCRIPT}

LINK_NAME=${1}
VERSION_MAV=${2}

SALIDA_cp_path_to_mavlocal_core=0

NOMBRE_SCRIPT_cp_path_to_mavlocal_core=cp_path_to_mavlocal_core
PARAMETROS_SCRIPT_cp_path_to_mavlocal_core="LINK_NAME VERSION_MAV"
...
e_pmt ${NOMBRE_SCRIPT_cp_path_to_mavlocal_core} ${PARAMETROS_SCRIPT_cp_path_to_mavlocal_core}
...
SALIDA_cp_path_to_mavlocal_core=${SALIDA_cp_path_to_mav}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
INFO_SCRIPT=${INFO_SCRIPT_cp_path_to_mavlocal_core}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_cp_path_to_mavlocal_core}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_cp_path_to_mavlocal_core}
...
return ${SALIDA_cp_path_to_mavlocal_core}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
