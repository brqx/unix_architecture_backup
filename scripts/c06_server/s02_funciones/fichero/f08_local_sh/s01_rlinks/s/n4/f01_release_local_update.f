...
#-------------------------------------------------------------------
#-- release_local_update
#-------------------------------------------------------------------
#+ Funciones / Variables Requeridas
#-------------------------------------------------------------------
#-- e_pmt - version_local_update
#-------------------------------------------------------------------
#+ Informacion : 
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E release_local_update -- Actualiza la ultima release en el entorno
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

release_local_update()
{
IS_release_local_update="Subimos de version maven a todo arquitectura"
INFO_SCRIPT=${IS_release_local_update}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_release_local_update=${INFO_SCRIPT}

VERSION_MAV=${1}
RUTA_DESCARGAS=${2}

SALIDA_release_local_update=0

NOMBRE_SCRIPT_release_local_update=release_local_update
PARAMETROS_SCRIPT_release_local_update="[VERSION]"
...
e_pmt ${NOMBRE_SCRIPT_release_local_update} ${PARAMETROS_SCRIPT_release_local_update}
...
mvn_local_update_release ${VERSION_MAV}
SALIDA_release_local_update=${SALIDA_mvn_local_update_release}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
if [ "${SALIDA_mvn_local_update_release}" == "0" ] ; then
#----====----====----====----====----====----====----====----====---
...
INFO_SCRIPT=${INFO_SCRIPT_release_local_update}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_release_local_update}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_release_local_update}
...
return ${SALIDA_release_local_update}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
