...
#-------------------------------------------------------------------
#-- print_dead_backup_fs_data
#-------------------------------------------------------------------
#+ Funciones / Variables Requeridas
#-------------------------------------------------------------------
#-- e_pmt - get_dead_backup_fs_data
#-------------------------------------------------------------------
#+ Informacion : 
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E print_dead_backup_fs_data zi  -- Devuelve los datos para la cuenta zi
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#-mini alias pps
print_dead_backup_fs_data()
{
IS_print_dead_backup_fs_data="Imprime los datos para la cuenta indicada"
INFO_SCRIPT=${IS_print_dead_backup_fs_data}
...
e_pmt print_dead_backup_fs_data "cuenta [proyecto] [enfoque]"
...
linea_alterna
echo "Ruta Backup FS Origen    : ${RUTA_FS_ORIGEN}              "
echo "Ruta Backup FS Destino   : ${RUTA_FS_DESTINO}             "
echo "Nombre fichero FS Export : ${NOMBRE_FICHERO_SITE}         "
linea_normal
