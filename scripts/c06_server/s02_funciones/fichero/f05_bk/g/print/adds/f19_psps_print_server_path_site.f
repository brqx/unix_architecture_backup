...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E print_path_site zi  -- Devuelve los datos para la cuenta zi
#-------------------------------------------------------------------
#E print_path_site zi parques -- Devuelve los datos para la cuenta zi:parques
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#-mini alias pps
print_path_site()
{
IS_print_path_site="Imprime los datos para la cuenta indicada"
INFO_SCRIPT=${IS_print_path_site}
#-------------------------------------------------------------------
...
e_pmt print_path_site "cuenta [proyecto]"
