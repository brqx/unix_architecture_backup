...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E print_live_backup_db_data zi  -- Devuelve los datos para la cuenta zi
#-------------------------------------------------------------------
#E print_live_backup_db_data zi parques -- Devuelve los datos para la cuenta zi:parques
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#-mini alias pdbdd
print_live_backup_db_data()
{
IS_print_live_backup_db_data="Imprime los datos para la cuenta indicada"
INFO_SCRIPT=${IS_print_live_backup_db_data}
#-------------------------------------------------------------------
...
e_pmt print_live_backup_db_data "cuenta [proyecto]"
...
get_live_backup_db_data ${CUENTA} ${PROYECTO} 
...
linea_normal
echo "Ruta FS Origen           : ${RUTA_LIVE_FS_ORIGEN}         "
echo "Ruta FS Destino          : ${RUTA_LIVE_FS_DESTINO}        "
linea_normal
