...
#+ Informacion : 
#-------------------------------------------------------------------
#I Sincroniza ficheros desde otro servidor 
#-------------------------------------------------------------------
#- Sistema de Meta tags en scripts
#-------------------------------------------------------------------
#T sincronismo ficheros servidor remoto
#-------------------------------------------------------------------
#+ Parametros : 
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E sync_file_from_server root ibrqx.com 22 mifichero -- Sincroniza desde ibrqx
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
# Sincroniza el fichero desde otro servidor
sync_file_from_server()
{
IS_sync_file_from_server="Sincroniza un fichero desde servidor destino."
INFO_SCRIPT=${IS_sync_file_from_server}
...
rsync -avz -e "ssh -oPort=${db_port}" root@${SERVER}:${remote_outgoing} ${local_outgoing}/${FICHERO}
