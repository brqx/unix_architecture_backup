...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E sync_local_to_custom soa7a -- Sincroniza contra soa7a la ruta actual
#-------------------------------------------------------------------
#E sync_local_to_custom soa7a /a/b/c -- Sincroniza contra soa7a en la ruta /a/b/c
#-------------------------------------------------------------------
#E sylocu 204  -- Sincroniza contra un filtro de servidor 204 en ruta actual
#-------------------------------------------------------------------
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
sync_local_to_custom()
{
IS_sync_local_to_custom="Sincroniza una ruta con servidor destino."
INFO_SCRIPT=${IS_sync_local_to_custom}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_sync_local_to_custom=${INFO_SCRIPT}
...
SALIDA_sync_local_to_custom=0

NOMBRE_SCRIPT_sync_local_to_custom=sync_local_to_custom
...
e_pmt ${NOMBRE_SCRIPT_sync_local_to_custom} ${PARAMETROS_SCRIPT_sync_local_to_custom}
...
INFO_SCRIPT=${INFO_SCRIPT_sync_local_to_custom}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_sync_local_to_custom}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_sync_local_to_custom}
...
return ${SALIDA_sync_local_to_custom}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
