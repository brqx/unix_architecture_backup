...
cp_path_to_mav()
{
IS_cp_path_to_mav="Copia ficheros sincronizando la ruta actual. No respeta los enlaces"
INFO_SCRIPT=${IS_cp_path_to_mav}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_cp_path_to_mav=${INFO_SCRIPT}
...
SALIDA_cp_path_to_mav=0

NOMBRE_SCRIPT_cp_path_to_mav=cp_path_to_mav
PARAMETROS_SCRIPT_cp_path_to_mav="dest ficheros version link_name"
...
e_pmt ${NOMBRE_SCRIPT_cp_path_to_mav} ${PARAMETROS_SCRIPT_cp_path_to_mav}
...
RUTA_ARQORIGEN_COPIA=${PWD}/${ESTRUCTURA}
...
##echo "Lanzamos cp_path_to_server ${RUTA_ARQORIGEN_COPIA} ${RUTA_ARQFINAL_PADRE}"

let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
cp_path_to_server ${RUTA_ARQORIGEN_COPIA} ${RUTA_ARQFINAL_PADRE}  
SALIDA_cp_path_to_mav=${SALIDA_cp_path_to_server}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
#- 7.Borramos libreria ya que al ser copia local ya se ha actualizado

##echo "Borrando ${RUTA_ARQORIGEN_COPIA}"

rm -rf ${RUTA_ARQORIGEN_COPIA}					&> /dev/null
...
INFO_SCRIPT=${INFO_SCRIPT_cp_path_to_mav}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_cp_path_to_mav}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_cp_path_to_mav}
