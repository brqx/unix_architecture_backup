...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cf_path_to_arqserver_link ibm core 22 DEST FICH v55 release -- Actualiza la version v55 como release
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Posible alias cfs
cf_path_to_arqserver_link()
{
IS_cf_path_to_arqserver_link="Copia ficheros sincronizando la ruta actual. No respeta los enlaces"
INFO_SCRIPT=${IS_cf_path_to_arqserver_link}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_cf_path_to_arqserver_link=${INFO_SCRIPT}
...
SALIDA_cf_path_to_arqserver_link=0
...
e_pmt cf_path_to_arqserver_link "[usuario] [servidor] [puerto] origen destino [version] "
...
#-Aqui debe venir el parametro : lastversion - release
RUTA_LASTVERSION=${RUTA_DESTINO}/${ENLACE}
