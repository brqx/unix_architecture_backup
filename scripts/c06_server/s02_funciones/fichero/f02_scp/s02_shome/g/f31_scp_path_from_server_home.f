...
cf_from_server_home()
{
IS_cf_from_server_home="Copia ficheros a un servidor via SSH partiendo el home"
INFO_SCRIPT=${IS_cf_from_server_home}
...
echo "Copiando Desde : ${SERVER}::${RUTA_FINAL_REMOTA} : $PORT"
echo "Hacia ruta     : ${src} :  "

# Suponemos que lo hacemos desde la ruta actual en el servidor origen

scp -r -P ${PORT}  ${USUARIO_CONEXION}@${SERVER}:${RUTA_FINAL_REMOTA}/${FICHEROS} ${PWD}
...
e_pmt cf_from_server_home "usuario host port"
