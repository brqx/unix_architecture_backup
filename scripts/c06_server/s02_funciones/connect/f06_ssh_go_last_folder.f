...
get_ssh_last_folder ${IP_CONEXION} ${PUERTO_CONEXION} ${USUARIO_CONEXION} 

ssh ${USUARIO_CONEXION}@${IP_CONEXION} -p ${PUERTO_CONEXION} -t "cd ${FOLDER}; bash --login"
