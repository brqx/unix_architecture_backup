...
#-------------------------------------------------------------------
#-- bk_fullsite_to_server
#-------------------------------------------------------------------
#+ Funciones / Variables Requeridas
#-------------------------------------------------------------------
#-- e_pmt - bk_full_to_server - bk_db_to_server
#-------------------------------------------------------------------
#+ Informacion : 
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E bk_fullsite_to_server palillos soa7a -- backup de palillos en servidor soa7a
#-------------------------------------------------------------------
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
bk_fullsite_to_server()
{
IS_bk_fullsite_to_server="Backup ful site en servidor destino."
INFO_SCRIPT=${IS_bk_fullsite_to_server}
...
e_pmt bk_fullsite_to_server "[usuario] [servidor]"
...
bk_full_to_server ${CUENTA} ${SERVIDOR}
