...
#+ Informacion : 
#-------------------------------------------------------------------
#I Busca clases duplicadas  dentro de un conjunto de jars
#-------------------------------------------------------------------
#- Sistema de Meta tags en scripts
#-------------------------------------------------------------------
#T busqueda clase dups duplicated java jar class clases search duplicadas
#-------------------------------------------------------------------
#+ Parametros : 
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E ldupjava				-- Lista clases duplicadas y su contenedor
#-------------------------------------------------------------------
#E ldupclass			-- Lista clases duplicadas y su contenedor
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#- Alias ldupjava - ldupclass
java_dup_classes()
{
IS_java_dup_classes="Lista todas las clases duplicadas de los jars indicados"
INFO_SCRIPT=${IS_java_dup_classes}
#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_java_dup_classes=${INFO_SCRIPT}

RUTA_JAR_PASADO=${1}

SALIDA_java_dup_classes=0

NOMBRE_SCRIPT_java_dup_classes=java_dup_classes
PARAMETROS_SCRIPT_java_dup_classes="[RUTA CONTENEDOR_JAR]"
...
e_pmt ${NOMBRE_SCRIPT_java_dup_classes} ${PARAMETROS_SCRIPT_java_dup_classes}
...
SALIDA_java_dup_classes=${CODIGO_salida}
...
INFO_SCRIPT=${INFO_SCRIPT_java_dup_classes}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_java_dup_classes}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_java_dup_classes}
...
return ${SALIDA_java_dup_classes}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
