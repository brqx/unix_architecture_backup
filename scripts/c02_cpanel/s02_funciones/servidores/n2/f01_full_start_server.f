...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E full_start_server  	-- Inicio completo del servidor
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

full_start_server()
{
IS_full_start_server="Inicia servidor"
INFO_SCRIPT=${IS_full_start_server}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_full_start_server=${INFO_SCRIPT}

ID_WAS=${1}

SALIDA_full_start_server=0

NOMBRE_SCRIPT_full_start_server=full_start_server
PARAMETROS_SCRIPT_full_start_server="[-?]"
...
e_pmt ${NOMBRE_SCRIPT_full_start_server} ${PARAMETROS_SCRIPT_full_start_server}
...
full_start_services 
SALIDA_full_start_server=${SALIDA_full_start_services}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
full_ckrun_services
SALIDA_full_start_server=${SALIDA_full_ckrun_services}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
INFO_SCRIPT=${INFO_SCRIPT_full_start_server}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_full_start_server}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_full_start_server}
...
return ${SALIDA_full_start_server}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
