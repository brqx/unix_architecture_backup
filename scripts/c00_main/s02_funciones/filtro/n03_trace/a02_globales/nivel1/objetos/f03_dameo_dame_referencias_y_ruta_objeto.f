...
#+ Informacion : 
#-------------------------------------------------------------------
#I Devuelve las referencias a los objetos indicando la ruta de las mismas
#-------------------------------------------------------------------
...
dameo()
{
IS_dameo="Devuelve las referencias a los objetos indicando la ruta de las mismas"
