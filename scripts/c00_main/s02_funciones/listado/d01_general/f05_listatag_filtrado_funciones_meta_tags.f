...
#+ Informacion : 
#-------------------------------------------------------------------
#I Lista las funciones que se ajustan a los tags solicitados
#-------------------------------------------------------------------
...
#-- Ejemplos :
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
#E listatag  filtro -- Muestra las funciones que responden a los filtros
#-==================================================================
...
listatag()
{
IS_listatag="Lista las funciones que se ajustan a los tags solicitados"
INFO_SCRIPT=${IS_listatag}
...
CADENA="find $PWD -type f | xargs grep '^#T ' ${CADENA} | cut -d ':' -f1" 
