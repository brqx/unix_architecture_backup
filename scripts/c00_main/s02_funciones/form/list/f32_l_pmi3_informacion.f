...
l_pmi3()
{
IS_l_pmi3="Permite parametrizar la salida de informacion de funciones. Inlcuye informacion adiccional"
EINFO_SCRIPT=${IS_l_pmi3}
...
e_pmt l_pmi3 "[NOMBRE_FUNCION] [MENSAJE] [INFORMACION] "
else
#-------------------------------------------------------------------
