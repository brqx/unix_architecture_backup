...
e_pmt()
{
IS_e_pmt="Permite parametrizar la salida de informacion de funciones. Incluye formato y particularidades y texto de error"
EINFO_SCRIPT=${IS_e_pmt}


NOMBRE_FUNCION=$1
ARGUMENTOS=$(echo $2 $3 $4 $5 $6 $7 $8 $9 | tr -s " ")

#-Si queremos indicar otro error debemos pasar una cadena en la variable E_TEXTO_ERROR
if [ "${E_TEXTO_ERROR}" == "" ] ; then
