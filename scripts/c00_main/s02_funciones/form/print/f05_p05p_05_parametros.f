...
#+ Ejemplo : 
#-------------------------------------------------------------------
# p_p3p p01 p02 p03  -- Presenta un formulario de informacion con 3 par
#-------------------------------------------------------------------

# Imprime el formulario con un parametro de entrada
p_p5p()
{
IS_p_p5p="Imprime el formulario con dos parametros de entrada"
EINFO_SCRIPT=${IS_p_p5p}
...
e2_pmt p_p5p "Error de parametros. Mirar"
...
linea_caracter "="
#--------------------------------------------------------------------
rm -f ${PANTALLA_EXTENDIDA_SCRIPT} &> /dev/null
#--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==
fi
