...
#+ Ejemplo : 
#-------------------------------------------------------------------
# p_p25p p01 p02 p03  -- Presenta un formulario de informacion con 3 par
#-------------------------------------------------------------------

# Imprime el formulario con un parametro de entrada
p_p25p()
{
IS_p_p25p="Imprime el formulario con dos parametros de entrada"
EINFO_SCRIPT=${IS_p_p25p}
...
e2_pmt p_p25p "Error de parametros. Mirar"
