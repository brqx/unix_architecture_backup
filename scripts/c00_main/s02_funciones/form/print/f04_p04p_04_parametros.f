...
#+ Ejemplo : 
#-------------------------------------------------------------------
# p_p4p p01 p02  -- Presenta un formulario de informacion con 2 par
#-------------------------------------------------------------------

# Imprime el formulario con un parametro de entrada
p_p4p()
{
IS_p_p4p="Imprime el formulario con dos parametros de entrada"
EINFO_SCRIPT=${IS_p_p4p}
...
e2_pmt p_p4p "Error de parametros. Mirar"
