...
#+ Ejemplo : 
#-------------------------------------------------------------------
# p_p23p p01 p02 p03  -- Presenta un formulario de informacion con 3 par
#-------------------------------------------------------------------

# Imprime el formulario con un parametro de entrada
p_p23p()
{
IS_p_p23p="Imprime el formulario con dos parametros de entrada"
EINFO_SCRIPT=${IS_p_p23p}
...
e2_pmt p_p23p "Error de parametros. Mirar"
