...
#+ Ejemplo : 
#-------------------------------------------------------------------
# p_p17p p01 p02 p03  -- Presenta un formulario de informacion con 3 par
#-------------------------------------------------------------------

# Imprime el formulario con un parametro de entrada
p_p17p()
{
IS_p_p17p="Imprime el formulario con dos parametros de entrada"
EINFO_SCRIPT=${IS_p_p17p}
...
e2_pmt p_p17p "Error de parametros. Mirar"
