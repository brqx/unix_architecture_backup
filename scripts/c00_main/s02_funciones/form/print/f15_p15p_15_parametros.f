...
#+ Ejemplo : 
#-------------------------------------------------------------------
# p_p15p p01 p02 p03  -- Presenta un formulario de informacion con 3 par
#-------------------------------------------------------------------

# Imprime el formulario con un parametro de entrada
p_p15p()
{
IS_p_p15p="Imprime el formulario con dos parametros de entrada"
EINFO_SCRIPT=${IS_p_p15p}
...
e2_pmt p_p15p "Error de parametros. Mirar"
