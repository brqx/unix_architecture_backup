...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E sort_3field fich_01     -- Ordena el fichero 01 por el primer campo
#-------------------------------------------------------------------
#E sort_3field fich_01 ";" -- Ordena fich_01 por el tercer campo con separador dos puntos
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#-Alias s1f
sort_3field()
{
IS_sort_3field="Ordena el fichero pasado por el campo indicado"
INFO_SCRIPT=${IS_sort_3field}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_sort_3field=${INFO_SCRIPT}

FICHERO=$1
SEPARADOR=$2

SALIDA_sort_3field=0

NOMBRE_SCRIPT_sort_3field=sort_3field
PARAMETROS_SCRIPT_sort_3field="FICHERO [SEPARADOR]"
...
e_pmt ${NOMBRE_SCRIPT_sort_3field} ${PARAMETROS_SCRIPT_sort_3field}
...
SALIDA_sort_3field=${SALIDA_sort_field}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
INFO_SCRIPT=${INFO_SCRIPT_sort_3field}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_sort_3field}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_sort_3field}
