...
#-------------------------------------------------------------------
#-- genera_celda_localidades_temporada
#-------------------------------------------------------------------
...
#+ Parametros : 
#-------------------------------------------------------------------
#P LINEA [TEMPORADA] [POS_CORTE] [URL]
#-------------------------------------------------------------------
#+ Ejemplo : 
#-------------------------------------------------------------------
#E genera_celda_localidades_temporada T LINEA -- Genera la celda en matriz de localidades
#-------------------------------------------------------------------
#E genera_celda_localidades_temporada 2008 $LINLAST 5 http://peloncita.com/dbload/
#-------------------------------------------------------------------
#E genera_celda_localidades_temporada 2006 $LIN06 7
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

genera_celda_localidades_temporada()
{
IS_genera_celda_localidades_temporada="Actualiza celda de matrices de lugares ciudades y paises"
INFO_SCRIPT=${IS_genera_celda_localidades_temporada}

INFO_SCRIPT_genera_celda_localidades_temporada=${INFO_SCRIPT}
...
SALIDA_genera_celda_localidades_temporada=0

NOMBRE_SCRIPT_genera_celda_localidades_temporada=genera_celda_localidades_temporada
PARAMETROS_SCRIPT_genera_celda_localidades_temporada="TEMPORADA LINEA [CORTE] [URL] "
...
e_pmt ${NOMBRE_SCRIPT_genera_celda_localidades_temporada} ${PARAMETROS_SCRIPT_genera_celda_localidades_temporada}
...
SALIDA_genera_celda_localidades_temporada=${SALIDA_genera_cadena_fotos_temporada}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
#--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
posiciona "Aleatorio Lugar: ${lugar}"
lugares_brqx[${lugar}]=${imagen}
...
if [ "${ALEATORIEDAD}" -gt "3" ] ; then
#--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
posiciona "Aleatorio TLugar: ${lugar}"
tlugares_brqx[${lugar}_${temporada}]=${imagen}
...
if [ "${ALEATORIEDAD}" -gt "3" ] ; then
#--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
posiciona "Aleatorio Ciudad: ${ciudad}"
ciudades_brqx[${ciudad}]=${imagen}
...
if [ "${ALEATORIEDAD}" -gt "3" ] ; then
#--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
posiciona "Aleatorio TCiudad: ${ciudad}"
tciudades_brqx[${ciudad}_${temporada}]=${imagen}
...
if [ "${ALEATORIEDAD}" -gt "3" ] ; then
#--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
posiciona "Aleatorio TPais : ${pais}"
tpaises_brqx[${pais}_${temporada}]=${imagen}
...
case ${SALIDA_genera_celda_localidades_temporada} in
'1' )
...
INFO_SCRIPT=${INFO_SCRIPT_genera_celda_localidades_temporada}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_genera_celda_localidades_temporada}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_genera_celda_localidades_temporada}
...
return ${SALIDA_genera_celda_localidades_temporada}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
