...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E genera_celda_recuerdos_last LINEA -- Genera la celda en matriz de recuerdos
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
genera_celda_recuerdos_last()
{
IS_genera_celda_recuerdos_last="Actualiza celda de matrices de lugares ciudades y paises"
INFO_SCRIPT=${IS_genera_celda_recuerdos_last}

INFO_SCRIPT_genera_celda_recuerdos_last=${INFO_SCRIPT}
...
SALIDA_genera_celda_recuerdos_last=0

NOMBRE_SCRIPT_genera_celda_recuerdos_last=genera_celda_recuerdos_last
PARAMETROS_SCRIPT_genera_celda_recuerdos_last="LINEA [SEP] [URL] "
...
e_pmt ${NOMBRE_SCRIPT_genera_celda_recuerdos_last} ${PARAMETROS_SCRIPT_genera_celda_recuerdos_last}
...
SALIDA_genera_celda_recuerdos_last=${SALIDA_genera_cadena_fotos_last}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
SALIDA_genera_celda_recuerdos_last=4
#------======------======------======------======------======------=
#----- [2] Inicio Existe el codigo para la foto
#------======------======------======------======------======------=
fi
...
case ${SALIDA_genera_celda_recuerdos_last} in
'1' )
...
INFO_SCRIPT=${INFO_SCRIPT_genera_celda_recuerdos_last}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_genera_celda_recuerdos_last}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_genera_celda_recuerdos_last}
...
return ${SALIDA_genera_celda_recuerdos_last}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
