...
#+ Parametros : 
#-------------------------------------------------------------------
#P LINEA [POS_CORTE] [URL] 
#-------------------------------------------------------------------
#+ Ejemplo : 
#-------------------------------------------------------------------
#E genera_celda_localidades LINEA -- Genera la celda en matriz de localidades
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
genera_celda_localidades()
{
IS_genera_celda_localidades="Actualiza celda de matrices de lugares ciudades y paises"
INFO_SCRIPT=${IS_genera_celda_localidades}

INFO_SCRIPT_genera_celda_localidades=${INFO_SCRIPT}

LINEA_PASADA=${1}
POSICION_CORTE_FICHERO=${2}
URL_BASE=${3}

SALIDA_genera_celda_localidades=0

NOMBRE_SCRIPT_genera_celda_localidades=genera_celda_localidades
PARAMETROS_SCRIPT_genera_celda_localidades="LINEA [SEP] [URL] "
...
e_pmt ${NOMBRE_SCRIPT_genera_celda_localidades} ${PARAMETROS_SCRIPT_genera_celda_localidades}
...
SALIDA_genera_celda_localidades=${SALIDA_genera_cadena_fotos}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
INFO_SCRIPT=${INFO_SCRIPT_genera_celda_localidades}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_genera_celda_localidades}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_genera_celda_localidades}
...
return ${SALIDA_genera_celda_localidades}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
