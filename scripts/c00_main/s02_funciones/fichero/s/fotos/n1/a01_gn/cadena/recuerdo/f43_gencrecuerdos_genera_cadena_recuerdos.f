...
#-------------------------------------------------------------------
#-- ecode - dcode - procesa_linea_codigos - rnd_num
#-------------------------------------------------------------------
#+ Informacion : 
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E genera_cadena_recuerdos LF -- Genera una linea con la cadena del evento
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
genera_cadena_recuerdos()
{
IS_genera_cadena_recuerdos="Genera cadena lugares para la linea indicada"
INFO_SCRIPT=${IS_genera_cadena_recuerdos}

INFO_SCRIPT_genera_cadena_recuerdos=${INFO_SCRIPT}

LINEA_FICHERO_RECUERDO="${1}"
SEP=${2}

SALIDA_genera_cadena_recuerdos=0

NOMBRE_SCRIPT_genera_cadena_recuerdos=genera_cadena_recuerdos
PARAMETROS_SCRIPT_genera_cadena_recuerdos="LINEA_FICHERO [CORTE] [URL] [SEP]"
...
## Sistema de auto documentacion de funciones
	...
	if [ "${SW_LLAMADA_DESDE_NIVEL_SUPERIOR}" == "0" ] ; then
		e_pmt ${NOMBRE_SCRIPT_genera_cadena_recuerdos} ${PARAMETROS_SCRIPT_genera_cadena_recuerdos}
	fi
...
indice_rnd=$(rnd_num ${cont_actual})
imss=
indice="${codigo}_${indice_rnd}"

if [ "${cinco_codigos[${indice}]}" != "" ] ; then
#--------========--------========--------========--------========---
#----- [4] Inicio matriz cinco codigos
#--------========--------========--------========--------========---
...
MOTIVO_FUNCION="No existe foto para el indice indicado"
SALIDA_genera_cadena_recuerdos=4;

#--------========--------========--------========--------========---
#----- [4] Fin matriz cinco codigos
#--------========--------========--------========--------========---
fi
else
...
SALIDA_genera_cadena_recuerdos=3;
...
INFO_SCRIPT=${INFO_SCRIPT_genera_cadena_recuerdos}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_genera_cadena_recuerdos}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_genera_cadena_recuerdos}
...
return ${SALIDA_genera_cadena_recuerdos}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
