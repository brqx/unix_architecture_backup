...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E genera_matriz_recuerdos_last 2012 -- Genera la las matrices para temporada 12
#-------------------------------------------------------------------
#E genera_matriz_recuerdos_last 2006 7 - Matrices year 2006 con posicion corte 7 
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
genera_matriz_recuerdos_last()
{
IS_genera_matriz_recuerdos_last="Genera las matrices necesarias para generar los lugares"
INFO_SCRIPT=${IS_genera_matriz_recuerdos_last}

INFO_SCRIPT_genera_matriz_recuerdos_last=${INFO_SCRIPT}
...
SALIDA_genera_matriz_recuerdos_last=0

NOMBRE_SCRIPT_genera_matriz_recuerdos_last=genera_matriz_recuerdos_last
PARAMETROS_SCRIPT_genera_matriz_recuerdos_last="[TEMPORADA] [FICHERO] [SEP] [URL] "
...
FICHERO_PASADO=${REPO_VIAJES}zpart/last/viaje_test.dat
FICHERO_CODIGOS=${RECFOTOS}zpart/last/entidad/zfoto_codigos.dat
fi  
...
e_pmt ${NOMBRE_SCRIPT_genera_matriz_recuerdos_last} ${PARAMETROS_SCRIPT_genera_matriz_recuerdos_last}
...
genera_celda_recuerdos_last ${LINEA_FICHERO} ${POSICION_CORTE_FICHERO} ${URL_BASE}
SALIDA_genera_matriz_recuerdos_last=${SALIDA_genera_celda_recuerdos_last}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
PARAMETROS_MOTIVO_03="Fichero Codigos : ${FICHERO_PASADO}"
...
case ${SALIDA_genera_matriz_recuerdos_last} in
'0' )
...
SALIDA_genera_matriz_recuerdos_last=3
...
INFO_SCRIPT=${INFO_SCRIPT_genera_matriz_recuerdos_last}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_genera_matriz_recuerdos_last}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_genera_matriz_recuerdos_last}
...
return ${SALIDA_genera_matriz_recuerdos_last}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
