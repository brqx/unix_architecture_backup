...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E tabulea LINEA   -- Formatea esalinea para poder tratarse
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#-Debe formatear la entrada para que la salida de la misma sea homogenea
tabulea()
{
IS_tabulea="Tabula todas las apariciones de una linea"
INFO_SCRIPT=${IS_tabulea}
...
e_pmt tabulea "LINEA_A_TABULEAR"
