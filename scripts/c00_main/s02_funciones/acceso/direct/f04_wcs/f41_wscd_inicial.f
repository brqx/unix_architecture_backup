...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wcsd syst   -- Entrara en la carpeta system
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wcsd()
{
IS_wcsd="Accede a una ruta filtrada con el comienzo del parametro"
INFO_SCRIPT=${IS_wcsd}
