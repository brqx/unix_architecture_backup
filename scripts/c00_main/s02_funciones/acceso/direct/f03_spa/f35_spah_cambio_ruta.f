...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E spah syst_nn   -- Entrara en la carpeta syst_nn
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#-Este nombre no me gusta pero de momento se queda
spah()
{
IS_spah="Cambia parte de la ruta actual por el parametro indicado"
INFO_SCRIPT=${IS_spah}
