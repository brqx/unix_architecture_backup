...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E oracle_su_pas_stop -- Para Oracle 
#-------------------------------------------------------------------
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

oracle_su_pas_stop()
{
IS_oracle_su_pas_stop="Ejecuta comando sql pasado como cadena"
INFO_SCRIPT=${IS_oracle_su_pas_stop}

INFO_SCRIPT_oracle_su_pas_stop=${INFO_SCRIPT}

ORACLE_SID=${1}
CADENA_START_DB=${2}
CONEXION_BD=${3}

SALIDA_oracle_su_pas_stop=0

NOMBRE_SCRIPT_oracle_su_pas_stop=oracle_su_pas_stop
PARAMETROS_SCRIPT_oracle_su_pas_stop="[CADENA_BD] [CONEXION]"
...
e_pmt ${NOMBRE_SCRIPT_oracle_su_pas_stop} ${PARAMETROS_SCRIPT_oracle_su_pas_stop}
...
run_sql ${CADENA_STOP_DB} ${CONEXION_BD}
SALIDA_oracle_su_pas_stop=${SALIDA_run_sql}
...
INFO_SCRIPT=${INFO_SCRIPT_oracle_su_pas_stop}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_oracle_su_pas_stop}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_oracle_su_pas_stop}
...
return ${SALIDA_oracle_su_pas_stop}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
