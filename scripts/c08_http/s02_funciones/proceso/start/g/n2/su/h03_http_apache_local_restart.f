...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E apache_local_restart s1 	-- Inicia el servicio indicado
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

apache_local_restart()
{
IS_apache_local_restart="Inicia el servidor web apache"
INFO_SCRIPT=${IS_apache_local_restart}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_apache_local_restart=${INFO_SCRIPT}

RUTA_SERVIDORES=${1}

SALIDA_apache_local_restart=0

#-Se trata de un texto de informacion a devolver al llamante
INFOSALIDA_apache_local_restart=""

NOMBRE_SCRIPT_apache_local_restart=apache_local_restart
PARAMETROS_SCRIPT_apache_local_restart="[-?]"
...
e_pmt ${NOMBRE_SCRIPT_apache_local_restart} ${PARAMETROS_SCRIPT_apache_local_restart}
...
INFO_SCRIPT=${INFO_SCRIPT_apache_local_restart}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_apache_local_restart}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_apache_local_restart}

e_pms 

else
#- Si no se presenta se deben eliminar parametros del nivel actual
INFOSALIDA_apache_local_restart=${MOTIVO_FUNCION}
limpia_parametros
...
return ${SALIDA_apache_local_restart}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
