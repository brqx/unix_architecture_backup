...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E apachesudo_local_start s1 	-- Inicia el servicio indicado
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

apachesudo_local_start()
{
IS_apachesudo_local_start="Inicia el servidor web apache"
INFO_SCRIPT=${IS_apachesudo_local_start}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_apachesudo_local_start=${INFO_SCRIPT}

RUTA_SERVIDORES=${1}

SALIDA_apachesudo_local_start=0

#-Se trata de un texto de informacion a devolver al llamante
INFOSALIDA_apachesudo_local_start=""

NOMBRE_SCRIPT_apachesudo_local_start=apachesudo_local_start
PARAMETROS_SCRIPT_apachesudo_local_start="[-?]"
...
e_pmt ${NOMBRE_SCRIPT_apachesudo_local_start} ${PARAMETROS_SCRIPT_apachesudo_local_start}
...
TIMESTAMP_apachesudo_local_start_01=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
http_su_pass_run_apache frontal6a
SALIDA_apachesudo_local_start=${SALIDA_http_su_pass_run_apache}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'114' )
posiciona "Frontal:${NUMERO_SERVIDOR}-iniciando"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
http_su_pass_run_apache frontal6b
SALIDA_apachesudo_local_start=${SALIDA_http_su_pass_run_apache}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'200' )
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
httpsudo_run_apache
SALIDA_apachesudo_local_start=${SALIDA_httpsudo_run_apache}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'201' )
posiciona "Core:${NUMERO_SERVIDOR}-iniciando"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
http_su_pass_run_apache soa6
SALIDA_apachesudo_local_start=${SALIDA_http_su_run_apache}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
get_current_timestamp
TIMESTAMP_apachesudo_local_start_02=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

#-Preparar la salida de la funcion

let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
stamp2date ${TIMESTAMP_apachesudo_local_start_01}
HORA_INICIAL=${RETORNO_stamp2date}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--


let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
diffstamps ${TIMESTAMP_apachesudo_local_start_02} ${TIMESTAMP_apachesudo_local_start_01}
TIEMPO_TARDADO_01=${RETORNO_diffstamps}
TIEMPO_TARDADO_02=$(echo ${RETORNO_difffechas} | cut -d " " -f2 )
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--


if [ "${SALIDA_apachesudo_local_start}" == "0" ] ; then
#--------========--------========--------========--------========---
...
INFO_SCRIPT=${INFO_SCRIPT_apachesudo_local_start}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_apachesudo_local_start}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_apachesudo_local_start}

e_pms 

else
#- Si no se presenta se deben eliminar parametros del nivel actual
INFOSALIDA_apachesudo_local_start=${MOTIVO_FUNCION}
limpia_parametros
...
return ${SALIDA_apachesudo_local_start}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
