...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E http_su_stop_apache s1 	-- Inicia el servicio indicado
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

http_su_stop_apache()
{
IS_http_su_stop_apache="Detiene el servidor web apache"
INFO_SCRIPT=${IS_http_su_stop_apache}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_http_su_stop_apache=${INFO_SCRIPT}

#-Comando es un espacio por defecto
COMANDO_STOP="${1} ${2} ${3}"

SALIDA_http_su_stop_apache=0

#-Se trata de un texto de informacion a devolver al llamante
INFOSALIDA_http_su_stop_apache=""

NOMBRE_SCRIPT_http_su_stop_apache=http_su_stop_apache
PARAMETROS_SCRIPT_http_su_stop_apache="[-?]"
...
e_pmt ${NOMBRE_SCRIPT_http_su_stop_apache} ${PARAMETROS_SCRIPT_http_su_stop_apache}
...
INFO_SCRIPT=${INFO_SCRIPT_http_su_stop_apache}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_http_su_stop_apache}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_http_su_stop_apache}

e_pms 

else
#- Si no se presenta se deben eliminar parametros del nivel actual
INFOSALIDA_http_su_stop_apache=${MOTIVO_FUNCION}
limpia_parametros
...
return ${SALIDA_http_su_stop_apache}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
