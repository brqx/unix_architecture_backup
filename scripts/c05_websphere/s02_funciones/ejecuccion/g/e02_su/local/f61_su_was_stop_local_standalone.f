...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wstop_su_local_standalone soa7a 	-- Detiene el servidor indicado 
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wstop_su_local_standalone()
{
IS_wstop_su_local_standalone="Detiene un servidor standalone remoto con un solo nodo"
INFO_SCRIPT=${IS_wstop_su_local_standalone}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wstop_su_local_standalone=${INFO_SCRIPT}

ID_WAS=${1}

SALIDA_wstop_su_local_standalone=0

NOMBRE_SCRIPT_wstop_su_local_standalone=wstop_su_local_standalone
PARAMETROS_SCRIPT_wstop_su_local_standalone="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wstop_su_local_standalone} ${PARAMETROS_SCRIPT_wstop_su_local_standalone}
...
SALIDA_wstop_su_local_standalone=${SALIDA_was_load_parameters_stop}
...
SALIDA_wstop_su_local_standalone=${SALIDA_stop_was_server}
...
INFO_SCRIPT=${INFO_SCRIPT_wstop_su_local_standalone}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wstop_su_local_standalone}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wstop_su_local_standalone}
...
return ${SALIDA_wstop_su_local_standalone}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
