...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wrun_su_local_standalone soa7a 	-- Lanza el script indicado para el servidor soa7a
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wrun_su_local_standalone()
{
IS_wrun_su_local_standalone="Inicia un servidor standalone remoto con un solo nodo"
INFO_SCRIPT=${IS_wrun_su_local_standalone}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wrun_su_local_standalone=${INFO_SCRIPT}

ID_WAS=${1}

SALIDA_wrun_su_local_standalone=0

NOMBRE_SCRIPT_wrun_su_local_standalone=wrun_su_local_standalone
PARAMETROS_SCRIPT_wrun_su_local_standalone="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wrun_su_local_standalone} ${PARAMETROS_SCRIPT_wrun_su_local_standalone}
...
SALIDA_wrun_su_local_standalone=${SALIDA_was_load_parameters}
...
SALIDA_wrun_su_local_standalone=${SALIDA_start_was_server}
...
INFO_SCRIPT=${INFO_SCRIPT_wrun_su_local_standalone}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wrun_su_local_standalone}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wrun_su_local_standalone}
...
return ${SALIDA_wrun_su_local_standalone}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
