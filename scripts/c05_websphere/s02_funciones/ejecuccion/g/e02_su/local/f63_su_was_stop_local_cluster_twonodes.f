...
#-------------------------------------------------------------------
#-- wstop_su_local_cluster_twonodes
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wstop_su_local_cluster_twonodes soa7a 	-- Lanza el script indicado para el servidor soa7a
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wstop_su_local_cluster_twonodes()
{
IS_wstop_su_local_cluster_twonodes="Para un cluster remoto con un solo nodo"
INFO_SCRIPT=${IS_wstop_su_local_cluster_twonodes}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wstop_su_local_cluster_twonodes=${INFO_SCRIPT}

#--Debemos insertar el shift pues vamos a llamar a scripts de ibm que cogen el $@
ID_WAS=${1}
shift

SALIDA_wstop_su_local_cluster_twonodes=0

NOMBRE_SCRIPT_wstop_su_local_cluster_twonodes=wstop_su_local_cluster_twonodes
PARAMETROS_SCRIPT_wstop_su_local_cluster_twonodes="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wstop_su_local_cluster_twonodes} ${PARAMETROS_SCRIPT_wstop_su_local_cluster_twonodes}
...
SALIDA_wstop_su_local_cluster_twonodes=${SALIDA_was_load_parameters_stop_cluster_twonodes}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
. ${LINEA_COMANDO_SERVIDOR_02}			&> /dev/null
SALIDA_stop_was_server=$?

posiciona "03_Stop:Servidor-02-detenido-${ID_WAS}"

SALIDA_wstop_su_local_cluster_twonodes=${SALIDA_stop_was_server}
...
. ${LINEA_COMANDO_NODO_02}				&> /dev/null
SALIDA_stop_was_nodo=$?

posiciona "06_Stop:Nodo-detenido-${ID_WAS}"

SALIDA_wstop_su_local_cluster_twonodes=${SALIDA_stop_was_nodo}
...
SALIDA_wstop_su_local_cluster_twonodes=${SALIDA_stop_was_manager}
...
INFO_SCRIPT=${INFO_SCRIPT_wstop_su_local_cluster_twonodes}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wstop_su_local_cluster_twonodes}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wstop_su_local_cluster_twonodes}
...
return ${SALIDA_wstop_su_local_cluster_twonodes}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
