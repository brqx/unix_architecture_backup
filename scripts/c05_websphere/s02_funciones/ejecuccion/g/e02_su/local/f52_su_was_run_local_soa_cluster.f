...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wrun_su_local_soa_cluster soa7a 	-- Lanza el script indicado para el servidor soa7a
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wrun_su_local_soa_cluster()
{
IS_wrun_su_local_soa_cluster="Inicia un cluster SOA local con un solo nodo"
INFO_SCRIPT=${IS_wrun_su_local_soa_cluster}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wrun_su_local_soa_cluster=${INFO_SCRIPT}

ID_WAS=${1}
shift

SALIDA_wrun_su_local_soa_cluster=0

NOMBRE_SCRIPT_wrun_su_local_soa_cluster=wrun_su_local_soa_cluster
PARAMETROS_SCRIPT_wrun_su_local_soa_cluster="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wrun_su_local_soa_cluster} ${PARAMETROS_SCRIPT_wrun_su_local_soa_cluster}
...
TIMESTAMP_01_wrun_su_local_soa_cluster=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
SALIDA_wrun_su_local_soa_cluster=${SALIDA_was_load_parameters_soa_cluster}
...
SALIDA_wrun_su_local_soa_cluster=${SALIDA_start_was_manager}
...
SALIDA_wrun_su_local_soa_cluster=${SALIDA_start_was_nodo}
...
. ${LINEA_COMANDO_SERVIDOR_03}			&> /dev/null
SALIDA_start_was_server=${SALIDA_was}

posiciona "08_Start:Servidor3-Arrancado-${ID_WAS}"

SALIDA_wrun_su_local_soa_cluster=${SALIDA_start_was_server}
...
INFO_SCRIPT=${INFO_SCRIPT_wrun_su_local_soa_cluster}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wrun_su_local_soa_cluster}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wrun_su_local_soa_cluster}
...
return ${SALIDA_wrun_su_local_soa_cluster}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
