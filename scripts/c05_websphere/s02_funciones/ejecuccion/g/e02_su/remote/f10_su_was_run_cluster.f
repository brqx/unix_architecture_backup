...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wrun_su_remote_cluster soa7a 	-- Lanza el script indicado para el servidor soa7a
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wrun_su_remote_cluster()
{
IS_wrun_su_remote_cluster="Inicia un cluster remoto con un solo nodo"
INFO_SCRIPT=${IS_wrun_su_remote_cluster}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wrun_su_remote_cluster=${INFO_SCRIPT}

ID_WAS=${1}

SALIDA_wrun_su_remote_cluster=0

NOMBRE_SCRIPT_wrun_su_remote_cluster=wrun_su_remote_cluster
PARAMETROS_SCRIPT_wrun_su_remote_cluster="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wrun_su_remote_cluster} ${PARAMETROS_SCRIPT_wrun_su_remote_cluster}
...
TIMESTAMP_01_wrun_su_remote_cluster=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
SALIDA_wrun_su_remote_cluster=${SALIDA_was_load_parameters}
...
posiciona "01_Start:Manager-${SERVER}"

SALIDA_wrun_su_remote_cluster=${SALIDA_ssh_surun}
...
posiciona "02_Start:Nodo-${SERVER}"
...
posiciona "03_Start:Servidor-${SERVER}"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
get_current_timestamp
TIMESTAMP_02_wrun_su_remote_cluster=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

#-Preparar la salida de la funcion

let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
stamp2date ${TIMESTAMP_01_wrun_su_remote_cluster}
HORA_INICIAL_wrun_su_remote_cluster=${RETORNO_stamp2date}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--


let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
diffstamps ${TIMESTAMP_02_wrun_su_remote_cluster} ${TIMESTAMP_01_wrun_su_remote_cluster}
TIEMPO_TARDADO_01_wrun_su_remote_cluster=${RETORNO_diffstamps}
TIEMPO_TARDADO_02_wrun_su_remote_cluster=$(echo ${RETORNO_difffechas} | cut -d " " -f2 )
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

MOTIVO_FUNCION="Inicio Cluster. Ejecuccion correcta."
PARAMETROS_MOTIVO_01="Hora Comienzo : ${HORA_INICIAL_wrun_su_remote_cluster}"
PARAMETROS_MOTIVO_02="Tiempo tardado: ${TIEMPO_TARDADO_02_wrun_su_remote_cluster} - ${TIEMPO_TARDADO_01_wrun_su_remote_cluster} segundos"
...
INFO_SCRIPT=${INFO_SCRIPT_wrun_su_remote_cluster}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wrun_su_remote_cluster}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wrun_su_remote_cluster}
...
return ${SALIDA_wrun_su_remote_cluster}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
