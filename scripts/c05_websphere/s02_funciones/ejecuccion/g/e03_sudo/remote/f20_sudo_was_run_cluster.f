...
wrunsudo_remote_cluster()
{
IS_wrunsudo_remote_cluster="Inicia un cluster remoto con un solo nodo"
INFO_SCRIPT=${IS_wrunsudo_remote_cluster}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wrunsudo_remote_cluster=${INFO_SCRIPT}

ID_WAS=${1}

SALIDA_wrunsudo_remote_cluster=0

NOMBRE_SCRIPT_wrunsudo_remote_cluster=wrunsudo_remote_cluster
PARAMETROS_SCRIPT_wrunsudo_remote_cluster="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wrunsudo_remote_cluster} ${PARAMETROS_SCRIPT_wrunsudo_remote_cluster}
...
SALIDA_wrunsudo_remote_cluster=${SALIDA_was_load_parameters}
