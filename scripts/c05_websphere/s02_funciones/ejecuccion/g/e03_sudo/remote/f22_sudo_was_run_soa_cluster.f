...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wrunsudo_remote_cluster soa7a 	-- Lanza el script indicado para el servidor soa7a
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wrunsudo_remote_soa_cluster()
{
IS_wrunsudo_remote_soa_cluster="Inicia un cluster SOA remoto con un solo nodo"
INFO_SCRIPT=${IS_wrunsudo_remote_soa_cluster}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wrunsudo_remote_soa_cluster=${INFO_SCRIPT}

ID_WAS=${1}

SALIDA_wrunsudo_remote_soa_cluster=0

NOMBRE_SCRIPT_wrunsudo_remote_soa_cluster=wrunsudo_remote_soa_cluster
PARAMETROS_SCRIPT_wrunsudo_remote_soa_cluster="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wrunsudo_remote_soa_cluster} ${PARAMETROS_SCRIPT_wrunsudo_remote_soa_cluster}
...
SALIDA_wrunsudo_remote_soa_cluster=${SALIDA_was_load_parameters}
...
SALIDA_wrunsudo_remote_soa_cluster=${SALIDA_ssh_sudorun}
...
MOTIVO_FUNCION="Ejecuccion correcta. Servidor Cluster SOA Iniciado."
...
INFO_SCRIPT=${INFO_SCRIPT_wrunsudo_remote_soa_cluster}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wrunsudo_remote_soa_cluster}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wrunsudo_remote_soa_cluster}
...
return ${SALIDA_wrunsudo_remote_soa_cluster}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
