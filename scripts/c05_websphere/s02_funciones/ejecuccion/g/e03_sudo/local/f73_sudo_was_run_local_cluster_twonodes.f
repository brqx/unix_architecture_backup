...
#-------------------------------------------------------------------
#-- wrunsudo_local_cluster_twonodes
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wrunsudo_local_cluster_twonodes core7b 	-- Lanza el script indicado para el servidor soa7a
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wrunsudo_local_cluster_twonodes()
{
IS_wrunsudo_local_cluster_twonodes="Inicia un cluster remoto con un solo nodo"
INFO_SCRIPT=${IS_wrunsudo_local_cluster_twonodes}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wrunsudo_local_cluster_twonodes=${INFO_SCRIPT}

ID_WAS=${1}
shift

SALIDA_wrunsudo_local_cluster_twonodes=0

NOMBRE_SCRIPT_wrunsudo_local_cluster_twonodes=wrunsudo_local_cluster_twonodes
PARAMETROS_SCRIPT_wrunsudo_local_cluster_twonodes="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wrunsudo_local_cluster_twonodes} ${PARAMETROS_SCRIPT_wrunsudo_local_cluster_twonodes}
...
TIMESTAMP_01_wrunsudo_local_cluster_twonodes=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
SALIDA_wrunsudo_local_cluster_twonodes=${SALIDA_was_load_parameters_cluster_twonodes}
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
get_current_timestamp
TIMESTAMP_02_wrunsudo_local_cluster_twonodes=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

#-Preparar la salida de la funcion

let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
stamp2date ${TIMESTAMP_01_wrunsudo_local_cluster_twonodes}
HORA_INICIAL_wrunsudo_local_cluster_twonodes=${RETORNO_stamp2date}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--


let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
diffstamps ${TIMESTAMP_02_wrun_su_local_cluster_twonodes} ${TIMESTAMP_01_wrun_su_local_cluster_twonodes}
TIEMPO_TARDADO_01_wrunsudo_local_cluster_twonodes=${RETORNO_diffstamps}
TIEMPO_TARDADO_02_wrunsudo_local_cluster_twonodes=$(echo ${RETORNO_difffechas} | cut -d " " -f2 )
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

MOTIVO_FUNCION="Inicio Cluster. Ejecuccion correcta."
PARAMETROS_MOTIVO_01="Hora Comienzo : ${HORA_INICIAL_wrunsudo_local_cluster_twonodes}"
PARAMETROS_MOTIVO_02="Tiempo tardado: ${TIEMPO_TARDADO_02_wrunsudo_local_cluster_twonodes} - ${TIEMPO_TARDADO_01_wrunsudo_local_cluster_twonodes} segundos"
...
INFO_SCRIPT=${INFO_SCRIPT_wrunsudo_local_cluster_twonodes}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wrunsudo_local_cluster_twonodes}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wrunsudo_local_cluster_twonodes}
...
return ${SALIDA_wrunsudo_local_cluster_twonodes}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
