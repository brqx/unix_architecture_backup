...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E was_load_parameters_stop  	-- Carga parametros para detener un was
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

was_load_parameters_stop()
{
IS_was_load_parameters_stop="Carga los parametros para detener un  was indicado"
INFO_SCRIPT=${IS_was_load_parameters_stop}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_was_load_parameters_stop=${INFO_SCRIPT}

ID_WAS=${1}
FICHERO_STOP=${2}
SEP=${3}

SALIDA_was_load_parameters_stop=0

NOMBRE_SCRIPT_was_load_parameters_stop=was_load_parameters_stop
PARAMETROS_SCRIPT_was_load_parameters_stop="[ID_WAS]"
...
e_pmt ${NOMBRE_SCRIPT_was_load_parameters_stop} ${PARAMETROS_SCRIPT_was_load_parameters_stop}
...
SALIDA_was_load_parameters_stop=${SALIDA_was_load_parameters}
...
SALIDA_was_load_parameters_stop=1
...
INFO_SCRIPT=${INFO_SCRIPT_was_load_parameters_stop}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_was_load_parameters_stop}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_was_load_parameters_stop}
...
return ${SALIDA_was_load_parameters_stop}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
