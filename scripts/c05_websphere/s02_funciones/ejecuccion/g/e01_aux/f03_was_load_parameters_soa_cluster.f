...
#-------------------------------------------------------------------
#-- was_load_parameters_soa_cluster
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E was_load_parameters_soa_cluster  	-- Carga parametros conexion WAS
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#alias cargar_datos_was
was_load_parameters_soa_cluster()
{
IS_was_load_parameters_soa_cluster="Carga los parametros para conectarte a un was indicado"
INFO_SCRIPT=${IS_was_load_parameters_soa_cluster}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_was_load_parameters_soa_cluster=${INFO_SCRIPT}

ID_WAS=${1}
FICHERO=${2}
SEP=${3}

SALIDA_was_load_parameters_soa_cluster=0

NOMBRE_SCRIPT_was_load_parameters_soa_cluster=was_load_parameters_soa_cluster
PARAMETROS_SCRIPT_was_load_parameters_soa_cluster="[ID_WAS]"
...
e_pmt ${NOMBRE_SCRIPT_was_load_parameters_soa_cluster} ${PARAMETROS_SCRIPT_was_load_parameters_soa_cluster}
...
NOMBRE_COMANDO_SERVIDOR_03="startServer.sh ${NOMBRE_SERVIDOR_03}"
...
PARAMETROS_MOTIVO_05="Nodo        : ${LINEA_COMANDO_NODO_01}"
PARAMETROS_MOTIVO_06="Servidor 01 : ${LINEA_COMANDO_SERVIDOR_01}"
PARAMETROS_MOTIVO_07="Servidor 02 : ${LINEA_COMANDO_SERVIDOR_02}"
PARAMETROS_MOTIVO_08="Servidor 03 : ${LINEA_COMANDO_SERVIDOR_03}"
...
INFO_SCRIPT=${INFO_SCRIPT_was_load_parameters_soa_cluster}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_was_load_parameters_soa_cluster}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_was_load_parameters_soa_cluster}
...
return ${SALIDA_was_load_parameters_soa_cluster}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
