...
#-------------------------------------------------------------------
#-- was_load_parameters_stop_cluster_twonodes
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E was_load_parameters_stop_cluster_twonodes  	-- Carga parametros para detener un was
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

was_load_parameters_stop_cluster_twonodes()
{
IS_was_load_parameters_stop_cluster_twonodes="Carga los parametros para detener un  was indicado"
INFO_SCRIPT=${IS_was_load_parameters_stop_cluster_twonodes}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_was_load_parameters_stop_cluster_twonodes=${INFO_SCRIPT}

ID_WAS=${1}
FICHERO_STOP=${2}
SEP=${3}

SALIDA_was_load_parameters_stop_cluster_twonodes=0

NOMBRE_SCRIPT_was_load_parameters_stop_cluster_twonodes=was_load_parameters_stop_cluster_twonodes
PARAMETROS_SCRIPT_was_load_parameters_stop_cluster_twonodes="[ID_WAS]"
...
e_pmt ${NOMBRE_SCRIPT_was_load_parameters_stop_cluster_twonodes} ${PARAMETROS_SCRIPT_was_load_parameters_stop_cluster_twonodes}
...
SALIDA_was_load_parameters_stop_cluster_twonodes=${SALIDA_was_load_parameters_cluster_twonodes}

if [ "${SALIDA_was_load_parameters_cluster_twonodes}" == "0" ] ; then
#--------========--------========--------========--------========---
#------- [2] Inicio Carga de datos contra el WAS indicado
#--------========--------========--------========--------========---

NOMBRE_SERVIDOR_01=$(echo ${LINEA_FICHERO} | cut -d ${SEP} -f8 )
NOMBRE_SERVIDOR_02=$(echo ${LINEA_FICHERO} | cut -d ${SEP} -f10 )
...
NOMBRE_COMANDO_NODO_02="stopNode.sh -username ${USER_STOP_SERVER} -password ${PASS_STOP_SERVER}"
...
LINEA_COMANDO_NODO_02=${RUTA_WAS}$(echo ${LINEA_FICHERO} | cut -d ${SEP} -f9 )${NOMBRE_COMANDO_NODO_02}
LINEA_COMANDO_SERVIDOR_01=${RUTA_WAS}$(echo ${LINEA_FICHERO} | cut -d ${SEP} -f7 )${NOMBRE_COMANDO_SERVIDOR_01}
LINEA_COMANDO_SERVIDOR_02=${RUTA_WAS}$(echo ${LINEA_FICHERO} | cut -d ${SEP} -f9 )${NOMBRE_COMANDO_SERVIDOR_02}
...
PARAMETROS_MOTIVO_06="Nodo    02  : ${LINEA_COMANDO_NODO_02}"
PARAMETROS_MOTIVO_07="Comando 01  : ${LINEA_COMANDO_SERVIDOR_01}"
PARAMETROS_MOTIVO_08="Comando 02  : ${LINEA_COMANDO_SERVIDOR_02}"
...
SALIDA_was_load_parameters_stop_cluster_twonodes=1
...
INFO_SCRIPT=${INFO_SCRIPT_was_load_parameters_stop_cluster_twonodes}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_was_load_parameters_stop_cluster_twonodes}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_was_load_parameters_stop_cluster_twonodes}
...
return ${SALIDA_was_load_parameters_stop_cluster_twonodes}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
