...
#-------------------------------------------------------------------
#-- was_load_parameters_cluster_twonodes
#-------------------------------------------------------------------
...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E was_load_parameters_cluster_twonodes  	-- Carga parametros conexion WAS
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

#alias cargar_datos_was
was_load_parameters_cluster_twonodes()
{
IS_was_load_parameters_cluster_twonodes="Carga los parametros para conectarte a un was indicado"
INFO_SCRIPT=${IS_was_load_parameters_cluster_twonodes}
...
SALIDA_was_load_parameters_cluster_twonodes=0

NOMBRE_SCRIPT_was_load_parameters_cluster_twonodes=was_load_parameters_cluster_twonodes
PARAMETROS_SCRIPT_was_load_parameters_cluster_twonodes="[ID_WAS]"
...
e_pmt ${NOMBRE_SCRIPT_was_load_parameters_cluster_twonodes} ${PARAMETROS_SCRIPT_was_load_parameters_cluster_twonodes}
...
NOMBRE_COMANDO_NODO="startNode.sh"
NOMBRE_COMANDO_SERVIDOR_01="startServer.sh ${NOMBRE_SERVIDOR_01}"
NOMBRE_COMANDO_SERVIDOR_02="startServer.sh ${NOMBRE_SERVIDOR_02}"


LINEA_COMANDO_MANAGER=${RUTA_WAS}$(echo ${LINEA_FICHERO} | cut -d ${SEP} -f6 )${NOMBRE_COMANDO_MANAGER}
LINEA_COMANDO_NODO_01=${RUTA_WAS}$(echo ${LINEA_FICHERO} | cut -d ${SEP} -f7 )${NOMBRE_COMANDO_NODO}
LINEA_COMANDO_NODO_02=${RUTA_WAS}$(echo ${LINEA_FICHERO} | cut -d ${SEP} -f9 )${NOMBRE_COMANDO_NODO}
...
PARAMETROS_MOTIVO_07="Servidor 01 : ${LINEA_COMANDO_SERVIDOR_01}"
PARAMETROS_MOTIVO_08="Servidor 02 : ${LINEA_COMANDO_SERVIDOR_02}"
