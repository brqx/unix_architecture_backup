...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wstop_su_pass_local_cluster soa7a 	-- Lanza el script indicado para el servidor soa7a
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wstop_su_pass_local_cluster()
{
IS_wstop_su_pass_local_cluster="Para un cluster remoto con un solo nodo"
INFO_SCRIPT=${IS_wstop_su_pass_local_cluster}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wstop_su_pass_local_cluster=${INFO_SCRIPT}

#--Debemos insertar el shift pues vamos a llamar a scripts de ibm que cogen el $@
ID_WAS=${1}
shift

SALIDA_wstop_su_pass_local_cluster=0

NOMBRE_SCRIPT_wstop_su_pass_local_cluster=wstop_su_pass_local_cluster
PARAMETROS_SCRIPT_wstop_su_pass_local_cluster="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wstop_su_pass_local_cluster} ${PARAMETROS_SCRIPT_wstop_su_pass_local_cluster}
...
SALIDA_wstop_su_pass_local_cluster=${SALIDA_was_load_parameters_stop}
...
SALIDA_wstop_su_pass_local_cluster=${SALIDA_stop_was_server}

if [ "${SALIDA_stop_was_server}" == "0" ] ; then
#--------========--------========--------========--------========---
#------- [2] Inicio Servidor del WAS
#--------========--------========--------========--------========---
...
SALIDA_wstop_su_pass_local_cluster=${SALIDA_stop_was_nodo}
...
SALIDA_wstop_su_pass_local_cluster=${SALIDA_stop_was_manager}

if [ "${SALIDA_stop_was_manager}" == "0" ] ; then
#--------========--------========--------========--------========---
#----------- [4] Inicio Manager del WAS
#--------========--------========--------========--------========---
...
INFO_SCRIPT=${INFO_SCRIPT_wstop_su_pass_local_cluster}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wstop_su_pass_local_cluster}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wstop_su_pass_local_cluster}
...
return ${SALIDA_wstop_su_pass_local_cluster}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
