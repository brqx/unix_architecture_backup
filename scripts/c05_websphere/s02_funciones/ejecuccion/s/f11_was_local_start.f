...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E was_local_start 	-- Reinicia el servidor indicado
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

was_local_start()
{
IS_was_local_start="Inicia el servidor indicado sin privilegios. Para lanzarlo con root."
INFO_SCRIPT=${IS_was_local_start}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_was_local_start=${INFO_SCRIPT}

RUTA_SERVIDORES=${1}

SALIDA_was_local_start=0

NOMBRE_SCRIPT_was_local_start=was_local_start
PARAMETROS_SCRIPT_was_local_start="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_was_local_start} ${PARAMETROS_SCRIPT_was_local_start}
...
TIMESTAMP_was_local_start_01=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrun_su_local_cluster frontal6a
SALIDA_was_local_start=${SALIDA_wrun_su_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'114' )
posiciona "Frontal:${NUMERO_SERVIDOR}-Iniciando"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrun_su_local_cluster frontal6b
SALIDA_was_local_start=${SALIDA_wrun_su_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'200' )
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrun_su_local_standalone soa7a
SALIDA_was_local_start=${SALIDA_wrun_su_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'203'  )
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrun_su_local_soa_cluster soa7b
SALIDA_was_local_start=${SALIDA_wrun_su_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'205' )
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
get_current_timestamp
TIMESTAMP_was_local_start_02=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

#-Preparar la salida de la funcion

let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
stamp2date ${TIMESTAMP_was_local_start_01}
HORA_INICIAL=${RETORNO_stamp2date}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--


let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
diffstamps ${TIMESTAMP_was_local_start_02} ${TIMESTAMP_was_local_start_01}
TIEMPO_TARDADO_01=${RETORNO_diffstamps}
TIEMPO_TARDADO_02=$(echo ${RETORNO_difffechas} | cut -d " " -f2 )
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

if [ "${SALIDA_was_local_start}" == "0" ] ; then
#--------========--------========--------========--------========---
...
INFO_SCRIPT=${INFO_SCRIPT_was_local_start}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_was_local_start}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_was_local_start}
