...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E was_local_stop 	-- Reinicia el servidor indicado
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

was_local_stop()
{
IS_was_local_stop="Reinicia el servidor indicado sin privilegios. Para lanzarlo con root."
INFO_SCRIPT=${IS_was_local_stop}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_was_local_stop=${INFO_SCRIPT}

RUTA_SERVIDORES=${1}

SALIDA_was_local_stop=0

NOMBRE_SCRIPT_was_local_stop=was_local_stop
PARAMETROS_SCRIPT_was_local_stop="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_was_local_stop} ${PARAMETROS_SCRIPT_was_local_stop}
...
TIMESTAMP_was_local_stop_01=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wstop_su_local_cluster frontal6a
SALIDA_was_local_stop=${SALIDA_wstop_su_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'114' )
posiciona "Frontal:${NUMERO_SERVIDOR}-Parando"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wstop_su_local_cluster frontal6b
SALIDA_was_local_stop=${SALIDA_wstop_su_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'200' )
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wstop_su_local_standalone soa7a
SALIDA_was_local_stop=${SALIDA_wstop_su_local_standalone}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'203'  )
posiciona "SOA:${NUMERO_SERVIDOR}-Parando"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wstop_su_local_soa_cluster soa7b
SALIDA_was_local_stop=${SALIDA_wstop_su_local_soa_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'205' )
...
posiciona "SOA:${NUMERO_SERVIDOR}-Parando"
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wstop_su_local_standalone soa6
SALIDA_was_local_stop=${SALIDA_wstop_su_local_standalone}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
esac
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
get_current_timestamp
TIMESTAMP_was_local_stop_02=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

#-Preparar la salida de la funcion

let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
stamp2date ${TIMESTAMP_was_local_stop_01}
HORA_INICIAL=${RETORNO_stamp2date}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--


let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
diffstamps ${TIMESTAMP_was_local_stop_02} ${TIMESTAMP_was_local_stop_01}
TIEMPO_TARDADO_01=${RETORNO_diffstamps}
TIEMPO_TARDADO_02=$(echo ${RETORNO_difffechas} | cut -d " " -f2 )
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

if [ "${SALIDA_was_local_stop}" == "0" ] ; then
#--------========--------========--------========--------========---
...
INFO_SCRIPT=${INFO_SCRIPT_was_local_stop}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_was_local_stop}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_was_local_stop}
