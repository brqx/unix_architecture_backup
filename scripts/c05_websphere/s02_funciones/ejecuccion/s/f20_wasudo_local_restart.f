...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E wasudo_local_restart 	-- Reinicia el servidor sin privilegios
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

wasudo_local_restart()
{
IS_wasudo_local_restart="Reinicia el servidor indicado sin privilegios"
INFO_SCRIPT=${IS_wasudo_local_restart}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_wasudo_local_restart=${INFO_SCRIPT}

RUTA_SERVIDORES=${1}

SALIDA_wasudo_local_restart=0

NOMBRE_SCRIPT_wasudo_local_restart=wasudo_local_restart
PARAMETROS_SCRIPT_wasudo_local_restart="ID_WAS"
...
e_pmt ${NOMBRE_SCRIPT_wasudo_local_restart} ${PARAMETROS_SCRIPT_wasudo_local_restart}
...
TIMESTAMP_wasudo_local_restart_01=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrestart_su_pass_local_cluster frontal6a 
SALIDA_wasudo_local_restart=${SALIDA_wrestart_su_pass_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'114' )
posiciona "Frontal:${NUMERO_SERVIDOR}-Reiniciando"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrestart_su_pass_local_cluster frontal6b 
SALIDA_wasudo_local_restart=${SALIDA_wrestart_su_pass_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'200' )
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrestartsudo_local_cluster core7a 
SALIDA_wasudo_local_restart=${SALIDA_wrestartsudo_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'201' )
posiciona "Core:${NUMERO_SERVIDOR}-Reiniciando"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrestartsudo_local_cluster core7b 
SALIDA_wasudo_local_restart=${SALIDA_wrestartsudo_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'202' )
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrestartsudo_local_standalone soa7a 
SALIDA_wasudo_local_restart=${SALIDA_wrestartsudo_local_standalone}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'203'  )
posiciona "SOA:${NUMERO_SERVIDOR}-Reiniciando"
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrestartsudo_local_soa_cluster soa7b
SALIDA_wasudo_local_restart=${SALIDA_wrestartsudo_local_soa_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'205' )
posiciona "Wsrr:${NUMERO_SERVIDOR}-Reiniciando"
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrestartsudo_local_cluster wsrr
SALIDA_wasudo_local_restart=${SALIDA_wrestartsudo_local_cluster}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
'304' )
posiciona "SOA:${NUMERO_SERVIDOR}-Reiniciando"
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
wrestart_su_pass_local_standalone soa6 
SALIDA_wasudo_local_restart=${SALIDA_wrestart_su_pass_local_standalone}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--
;;
esac
...
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
get_current_timestamp
TIMESTAMP_wasudo_local_restart_02=${RETORNO_get_current_timestamp}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--

#-Preparar la salida de la funcion

let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
stamp2date ${TIMESTAMP_wasudo_local_restart_01}
HORA_INICIAL=${RETORNO_stamp2date}
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--


let SW_LLAMADA_DESDE_NIVEL_SUPERIOR++
diffstamps ${TIMESTAMP_wasudo_local_restart_02} ${TIMESTAMP_wasudo_local_restart_01}
TIEMPO_TARDADO_01=${RETORNO_diffstamps}
TIEMPO_TARDADO_02=$(echo ${RETORNO_difffechas} | cut -d " " -f2 )
let SW_LLAMADA_DESDE_NIVEL_SUPERIOR--


if [ "${SALIDA_wasudo_local_restart}" == "0" ] ; then
#--------========--------========--------========--------========---
#-- [2] Inicio bloque resultado actualizacion
#--------========--------========--------========--------========---

MOTIVO_FUNCION="Servidor ${NOMBRE_SERVIDOR} Reinciando Correctamente (modo secuencial)"
...
INFO_SCRIPT=${INFO_SCRIPT_wasudo_local_restart}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_wasudo_local_restart}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_wasudo_local_restart}
...
return ${SALIDA_wasudo_local_restart}
#-------------------------------------------------------------------
#- Fin de la funcion
#-------------------------------------------------------------------
fi
