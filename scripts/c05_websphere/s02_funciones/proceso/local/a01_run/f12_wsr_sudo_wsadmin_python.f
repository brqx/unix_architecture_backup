...
#+ Informacion : 
#-------------------------------------------------------------------
#I Lanza el wsadmin del websphere indicado con sudo
#-------------------------------------------------------------------
...
sd_wsadmin_run_pyth()
{
IS_sd_wsadmin_run_pyth="Ejecuta el script python"
INFO_SCRIPT=${IS_sd_wsadmin_run_pyth}
...
e_pmp sd_wsadmin_run_pyth "SCRIPT_PYTH [RUTA]"
...
sudo ${RUTA_VARIABLES}wsadmin.sh -username ${ADMIN_DMGR_USER} -password ${ADMIN_DMGR_PASS}  \
