...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E sulist_perfiles_was		--		Informa de los perfiles y rutas existentes
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 


#-Futuro mini alias suvpf

sulist_perfiles_was()
{
IS_sulist_perfiles_was="Muestra los perfiles definidos en el servidor websphere"
INFO_SCRIPT=${IS_sulist_perfiles_was}
...
SALIDA_PERFILES=$(sudo ${WPS_RUN}manageprofiles.sh -listProfiles )
