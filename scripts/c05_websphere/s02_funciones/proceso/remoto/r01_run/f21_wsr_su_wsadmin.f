...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E suwsadmin_run_jacl soa7a scrip	-- Lanza el script JACL indicado
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
suwsadmin_run_jacl()
{
IS_suwsadmin_run_jacl="Saca las variables definidas en la celda"
INFO_SCRIPT=${IS_suwsadmin_run_jacl}

#-Guardamos la informacion actual del script. Es necesario si se invoca a scripts intermedios
INFO_SCRIPT_suwsadmin_run_jacl=${INFO_SCRIPT}
...
SALIDA_suwsadmin_run_jacl=0

NOMBRE_SCRIPT_suwsadmin_run_jacl=suwsadmin_run_jacl
PARAMETROS_SCRIPT_suwsadmin_run_jacl="ID_WAS ARCHIVO_JACL PARAMETROS_JACL [RUTA_WAS]"
...
e_pmt ${NOMBRE_SCRIPT_suwsadmin_run_jacl} ${PARAMETROS_SCRIPT_suwsadmin_run_jacl}
...
SALIDA_suwsadmin_run_jacl=${SALIDA_was_load_parameters_wsrun}
...
SALIDA_suwsadmin_run_jacl=${SALIDA_ssh_surun}
...
MOTIVO_FUNCION="Ejecuccion correcta. Comando lanzado."
