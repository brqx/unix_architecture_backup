...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E db_brqx_user_grants za  --> Lista permisos para ese usuario
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 

## mini alias dbgrants
db_brqx_user_grants()
{
IS_db_brqx_user_grants="Lista los permisos para un usuario de la Base de datos Mysql"
INFO_SCRIPT=${IS_db_brqx_user_grants}
...
e_pmt db_brqx_user_grants USUARIO

else

db_brqx_user_grants ${USUARIO}_brqx
