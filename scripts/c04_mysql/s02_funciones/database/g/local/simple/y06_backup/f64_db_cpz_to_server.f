...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E db_cpz_to_server U S 22 za_d50prok zu_d50prok  --> Copia bbdd za_d50prok en zu_d50prok
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
...
db_cpz_to_server()
{
IS_db_cpz_to_server="Copia la base de datos indicada en el servidor solicitado"
INFO_SCRIPT=${IS_db_cpz_to_server}

INFO_SCRIPT_db_cpz_to_server=${INFO_SCRIPT}
...
SALIDA_db_cpz_to_server=0

NOMBRE_SCRIPT_db_cpz_to_server=db_cpz_to_server
PARAMETROS_SCRIPT_db_cpz_to_server="USER SERVER PORT BD_LOCAL BD_REMOTA [RUTA_EXPORT]"
...
e_pmt ${NOMBRE_SCRIPT_db_cpz_to_server} ${PARAMETROS_SCRIPT_db_cpz_to_server}
...
SALIDA_db_cpz_to_server=${SALIDA_db_export}
...
SALIDA_db_cpz_to_server=${SALIDA_dbr_create}
...
SALIDA_db_cpz_to_server=${SALIDA_czf_path_to_server}
...
SALIDA_db_cpz_to_server=${SALIDA_dbr_restore}
...
ERROR_rm=$?
SALIDA_db_cpz_to_server=${ERROR_rm}
...
INFO_SCRIPT=${INFO_SCRIPT_db_cpz_to_server}
NOMBRE_SCRIPT=${NOMBRE_SCRIPT_db_cpz_to_server}
PARAMETROS_SCRIPT=${PARAMETROS_SCRIPT_db_cpz_to_server}
...
cd ${PATH_ACTUAL}
return ${SALIDA_db_cpz_to_server}
